...
- Broad/structural TODOs live in the master's own `@@TODO` section (Tower
  layout, consecutive card rule, lexicon two-readings pass, etc.). This file
  is for **specific proposed edits** that surface in discussion.

Status key: **PROPOSED** (awaiting author) · **DISCUSSED** · **APPLIED** · **DROPPED**
