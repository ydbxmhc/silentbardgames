...
Suit Effect **Hearts** You +1 token, opponent -1 token **Diamonds** You +1 token, opponent +1 token **Spades** You -1 token, opponent -1 token **Clubs** You -1 token, opponent +1 token
