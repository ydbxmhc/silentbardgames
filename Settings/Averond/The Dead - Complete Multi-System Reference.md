...
### Common Resource
---
5e Base: The Commoner
Used as the foundation for Pell, the Reincarnate, and as a variant base for the Zombie.
```
Commoner (Medium humanoid, any alignment, CR 0)
AC 10, HP 4 (1d8), Speed 30 ft.
All ability scores 10 (+0), Passive Perception 10
Languages: any one (usually Common)
Club. Melee Weapon Attack: +2 to hit, reach 5 ft. Hit: 2 (1d4) bludgeoning.
```

The other systems do not need a special template.

---

## Old Pell, the Drowned

*The sea kept him under too long, then sent him back with something extra in his ears.*

The village wisewoman saw him struggling for the shore, and saw him fail. She pulled him up the beach and pressed the cold salt water from his chest more from love than hope. He coughed, and lived. To the eye he is just an old fisherman mending nets, hauling lines, keeping his own counsel; but drowning left a door ajar, and the recently dead murmur through it ever since.
...
```
Level 1 Naturalist 1 Fishing 1
Hook: The Far Shore In His Ears
```
Tapped, the Hook lends an edge to anything involving the recently dead - sensing or speaking with them. 
As a liability, the dead sometimes overwhelm.
...
```
Weathered Coastal Fisherman ................. d8
  SFX: They Overwhelm Me - swap for a d4, earn a PP
Pay a PP, gain a d6 Asset: The Far Shore In My Ears
...
Death-Touched: Pell always carries a Condition of Touched by Death that cannot be removed. He tries to go about his business as usual, but at the GM's discretion he may become overwhelmed by the clamoring Dead at any time, giving PCs a Bad position on any rolls to get anything useful from him, or even making any such action Impossible.

Uncanny Knowledge: because he can see and hear the recently Dead, Pell can often answer questions about them, or about things going on in the area that he should have no way to know. This Uncanny Knowledge can give PCs advantageous position on situations at odd moments, particularly for actions like getting his help finding things when he couldn't otherwise know where to look.

4HP
Fists: 1D-1 Damage
Desperate Plea: 1D + 1D + 1D + 1D The Dead know Pell *can* hear them when most cannot. If he is threatened, they may manifest en masse to defend him. Pell himself will probably fold into a squat and cower, covering his head as he wails in fear, but the horde of the Dead crowding him will descend on those threatening him with a terrible vengeance.
```
---
...
```
Sense the Dead. Pell perceives spirits and recently dead creatures within 30 feet and may speak with them. He can also sense the direction of a recent death within one mile (Wisdom check, DC set by distance and time elapsed). He cannot choose to close this sense.

The Door Left Open. When too many or a strong or violent spirit comes within range - at the DM's discretion - Pell must make a DC 12 Wisdom saving throw or take 1 psychic damage and be frightened until a short rest. On a success he is unsettled but functional. 
```

---

## The Hanged Man of Gallows Hill

*He climbs steps that rotted to splinters and then dust generations ago, and weeps for a crowd that is not there.*

He comes under a waxing gibbous moon. The boards of a long-vanished gallows take shape beneath each foot and fade away behind him as he mounts the steps, hands bound, weeping. The magistrate's voice sounds somewhere, an unintelligible echo, but only the weeping is ever clear. He stands and shivers. He looks for help in a crowd no one living can see. He wails when the black bag settles over his face, and pleads, and wets himself. When the platform drops he kicks - still alive, still kicking - and swings, and his terror climbs to a crescendo that breaks across every mortal near him, then begins again.

There is no one behind the loop to reason with, bargain with, or defeat. He is not an opponent. He is a condition of the hill, sprung by the living who blunder into his grief. The dread he radiates strikes everyone present, all at once, and cannot be argued down - only endured. Those overcome by it flee, and may carry an aversion to returning until the memory fades or someone soothes it out of them.

His cruelty has no malice. He can be laid to rest only by answering the injustice that made him: learn his name, his crime or his innocence, and perhaps resolve it. Until then he returns with every waxing gibbous moon, and the hill remembers.
...
```
Level 1 Spectre 1 Display 1
Hook: Eternity on the Gallows
Traits: __Reactive__, __Insidious__, __Blanket__
Anchor: The location itself
```

He can only be targeted by those able to interact across the Veil.  
His Display strikes everyone present at full force (Blanket) and cannot be opposed, only resisted (Insidious), and fires on proximity alone (Reactive).  
He has no will; he is a trap.

---

### Fate Core (Scene Aspect, not NPC)
...
He can only be targeted by those able to interact across the Veil; they can attempt to dismantle the Aspect directly, though it always comes back later.  

---

### Cortex Prime (Location)
...
Effect - Echoes of Dread: each exchange under the waxing gibbous moon,
 ...
 On a win, inflict or step up Reliving His Execution (d6). 
 Past d12 the victim flees, the dread lingering until soothed.
```
PCs able to reach across the Veil may engage him as a d6 Spectre.
He does not directly resist, only continues his Echoes of Dread wailing.
...
```
Intangible: it is Impossible for characters unable to reach across the Veil to affect the Hanged Man.

1HP
Echoes of Dread: upon first seeing or hearing the Hanged Man's horrible fate, all PCs should make a Will Check; 
those who fail take a Disquieted condition. Disquiet is removed by a long rest.

Spectre's Wail: Make a Will Check. Those who fail may take a Disquieted condition if they do not already have one;
otherwise they must either take 1HP of psychic damage or an Overwhelmed condition (removed by a short rest) and flee at best speed. 

If they choose to take the damage, conventional armor *does not apply*. Any items they are forced to drop will 
most often be whatever is in their hand as they desperately try to cover their ears. 
...
For any PC capable of reaching across the Veil, he is the Commoner template again, trembling in his loop and persistently unaware of them while his agony causes the haunting. Destroying that shade will quiet the haunt until the next gibbous moon. 
```
...
*The body answers. The mind, walled up behind it, cannot - and that is the cruelty.*

A zombie is a corpse raised - not a soul returned, but a body reanimated with its mind sealed inside, stripped of every will but the one the animating spell asserts: Obey the Maker. It is not stupid, exactly; whatever wit it once had may still be in there, awake and aware, with no hand on the reins. It does as it is told, to the letter, because to the letter is all that remains. It will not improvise, reconsider, or stop. It does not flinch from wounds the way the living do, and it feels no fear at all. It needs no light to work and no rest to continue.

Its tireless obedience is a subtle threat, and the gap between a literal command and a clever world is its weakness. Tell it to guard the door and it will guard the door but ignore the open window. Tell it to walk through a wall and it will try until it cannot. The prisoner inside may understand every irony - the body will not act on the understanding. It cannot hold two commands, however, utterly unable to accept complex commands, conditions, or tasks which require multiple steps, unless the task is a simple one it *knew well in life...*

Averond zombies are Halflings, existing fully in both the physical and spirit worlds simultaneously, making them useful guards: their dead hands can close on a ghost as easily as a thief. They do not *fight*; told to destroy a target, they advance and strike, and their only defense is their attempt to push interposed weapons out of the way of their *task*. Told to defend, they interpose to soak the harm. Ordered to "take his weapon" they will placidly accept it through the body and then attempt to retain it. Bind it and it does not fight the rope so much as leave a part of itself in it - degloving a hand to slip the knot, or tearing the arm off and walking on. Even charming it only sways the mind that cannot make decisions. 

Damage is not a consideration. They feel no fear, no pain, no shock. Animated by spell and heedless of harm, they do not stop until there is nothing left to animate.

To end the body is, as often as not, a mercy. Remember that, before and after.
...
```
Level 1 Zombie 1 Heedless 1
Hook: Unquestioning Literal Obedience
Traits: Halfling; Reactive; Immune to Complications & Temporary Hooks; Constrained 1d[0-3]
Conceit: All physical damage the Zombie receives is treated as Unarmed.
```
Learn to Wager, or learn to run...
...
Stress: Physical [][][][][][][][][][]
```
Call your shots carefully.

### Cortex Prime
```
Zombie d6,6,6,6,6 (Mob)
  SFX: "Mindless" - Immune to Mental Complications
Halfling d8
  SFX: Vulnerable to incorporeal spirits; able to affect incorporeal spirits.
Pre-existing Complication: Clumsy d6
Permanent Unalterable Complication: Unflinchingly Obedient, Stupidly Literal d6
```
Treat the individual Zombie *as* a mob. Losing "members" represents loss of limbs and other bulk damage that hinders effectiveness. More Zombies just add more d6's to the Mob.
GM-rolled Hitches always add a *new* `Clumsy d6`.

### D&D 5e

```
Averond Zombie (Medium undead, CR 1/4)
AC 10 (or armor as provided), HP 22 (3d8+9), Speed 25 ft.
STR 13(+1) DEX 6(−2) CON 16(+3) INT 6(−2) WIS 6(−2) CHA 5(−3)
Saving Throws: Wis +0
...
Undead Fortitude. Con save (DC 5 + damage) when reduced to 0 HP or drop to 1 instead; not vs. radiant or a critical.
Bound Servant. Obeys its creator to the letter; takes no action on its own initiative.
Spirit-Touched. Its slam strikes incorporeal creatures, ignoring their resistance.

Slam. +3 to hit, 1d6+1 bludgeoning.

Note: INT 6 understates the trapped-mind truth. Handle through narration.
```
...
## Sgt. Aldous Vane, the Oathbound

*No rest while they thrive. No sunset, no letter to a fatherless child, no grave that holds. Only the road, and the ones at the end of it.*

Vane was a sergeant, and kept his men alive for a living. Then someone killed his company, and he swore an oath over the bodies that outlasted his own. He rose in a stranger's grave and dug himself out, and began walking.

He is not a ghost in any meaningful sense - he is fully present, tangible, breathing borrowed air in borrowed flesh, carrying a borrowed face that slowly morphs toward his own likeness as the body acclimatizes. He eats. He bleeds. He can be hurt, and fought, and apparently killed, and none of it takes. Destroy the body and his oath calls him back; he wakes in another grave within a day, sometimes weaker, sometimes not, and resumes the walk. He does not regenerate so much as refuse. The only cage that holds him is one no corpse can reach.

He always knows which way to walk. He cannot explain it - a taste in the air, a pull like tide - but he is never lost and never misdirected, and he will walk through a city he has never seen and arrive at your door as if he had the address. He can lay that same sense on a room and read the shape of what is about to happen. He can look a man in the eye and make him see what he did.

He is a sergeant. He does not waste effort. He will not fight his way through an army if the back gate is open. He is not cruel, not theatrical, and not interested in dramatics. He is interested in the ones at the end of the walk, and in nothing else until the walk is done.

The only endings available to him are three: the oath fulfilled, the oath proven already fulfilled, or someone powerful enough to release a soul from a binding it never asked for. The first may not be available to the party. They should think carefully about why that is.
...
Sneak 2
  Urban 2
  Social Camouflage 2
Hook: No Rest While They Thrive
Hook: Revenant
Anchor: The oath itself.
```

Full mechanical entry in the Vane artifact. Kill him all you want. He opens his eyes in another grave and digs.

### Fate Core (Main NPC)

```
High Concept: Revenant Sworn to Avenge His Slaughtered Company
Trouble: I Fade When the Last of Them Falls
Aspects: I Always Know Where They Are
...
Stunts
  Vengeful Tracker: always invoke I Always Know Where
    They Are to locate sworn quarry, no roll required.
  Relentless: when taken out, concede instead - vanish
    and reform in a new body within a day, unless the
    concession resolves his oath.
  Glare of the Grave: Provoke vs. sworn quarry; success
    with style = paralyzed reliving their crime rather
    than merely stressed.

Stress: Physical [1][2][3][4], Mental [1][2][3]
...
```
Distinctions
  Risen to Avenge His Slaughtered Company ..... d8
  No Rest While They Thrive .................. d8
  A Borrowed Corpse, a Sergeant's Wits ........ d8
Attributes: Physical d10, Mental d8, Social d8
Skills: Fight d8, Menace d8, Survival d8

SFX - Scent of Vengeance: add d8 to any pool to find
  or pursue sworn quarry.
SFX - Doomglare: on eye contact, inflict Forced to See
  What They Did Complication (Menace + Mental).
SFX - Corpse Fortitude: spend a PP to ignore a physical
  Complication a living man could not endure.
Limit - Sometimes They Come Back: when stressed out, he
  reforms in a new corpse within a day and resumes.
  Contained where no corpse can answer, he is trapped.
```

### D&D 5e (CR 5)

```
AC 13, HP 136 (16d8+64), Speed 30 ft.
STR 18(+4) DEX 14(+2) CON 18(+4) INT 13(+1) WIS 16(+3) CHA 18(+4)
Saves: Str +7, Con +7, Wis +6, Cha +7
Resistances: necrotic, psychic; B/P/S from nonmagical non-silvered attacks
Immunities: poison; charmed, exhaustion, frightened, paralyzed, poisoned

Regeneration. Regains 10 HP at start of turn (not after radiant or since last turn). Destroyed only if starts turn at 0 HP without regenerating.
Rejuvenation. On destruction, reforms in a new body in 24 hours. Ended only by fulfilling the oath, releasing it, or a wish.
Turn Immunity.
Vengeful Tracker. Always knows direction and distance to sworn quarry on the same plane.

Multiattack. Two fist attacks.
Fist. +7 to hit, 14 (2d8+4) bludgeoning; +14 (4d6) necrotic vs. sworn quarry.
Vengeful Glare. DC 15 Wis save; fail = paralyzed until end of Vane's next turn, reliving their crime.
```
...
*You will know her long before you meet her - by her servants, her debts, and the slow closing of a snare whose weaving you never saw.*

She began as a Shade a thousand years ago - one grieving, wanting soul like any other, trapped by a passion that would not release her. Then the Godling of Necromancy came offering, as such powers do, a way into the world. She signed. What she received was demonic craft and a long leash; what she became was his lieutenant, and she has spent ten centuries earning the title.

She is not a brute. Tahanos has brutes enough. Malisondre is his broker - the patient hand that turns a frightened village, a debt-ridden merchant, a wavering priest, by contract rather than force. She acts through what she has collected: bound dead, corrupted clergy, debtors, the seduced and the leveraged. The party feels her as a pattern before they find a hand to blame. Her element is air; she reaches across a city in a whisper, and the sense of being precisely understood in a sealed room at midnight is, more often than not, her.

She has no fixed form. She is a spirit, and form is only makeup - worn for the result it buys, shed the moment it stops buying. Manifest, she may be one of the flickering figures around her, or several, or the poison fog settling at your ankles, or the very air you are trying to breathe. Ghost-servants and cast phantoms move in her wake, some real and biting, some only the idea of a threat, and only a clear-sighted read of the spirit world tells which is which. That reading looks back. She will find the one set of eyes that can see her clearly and address them first, because once those eyes are closed the rest of the room is blind.

She is, under the thousand-year patience and the borrowed fire and the court of the dead, still the soul that signed the bargain - still capable of wanting something for herself. She cannot resist a contest she might lose against someone clever enough to make the stakes real. This is the seam. Everything else is armor.

She is not an encounter. She is a situation - a web of contracts and patience with a soul at its heart. Her undoing, if there is one, is not written here; that is a table's work, and the finding of it is the campaign.
...
Shade 6
  Display 6
  Manifestation 6
Succubus 5              (secondary Court: Demon)
  Possession 5
  Aura Reading 5
Performer 6
Loremaster 5
Sylph 2                 (tertiary Court: Air)
  Manifestation 2
Hook: Cannot Resist a Worthy Bargain 6
Hook: The Collar Chafes 6
Anchor: A clause in her contract with Tahanos.
```

Full entry in the Malisondre artifact. Manifest, she pools 24 dice before Boosts or Hooks - allocated, never spent whole. Her seam: force a contest only a Sylph can answer and that pool collapses to six.

### Fate Core (Nemesis NPC)

```
High Concept: The Thousand-Year Broker, Tahanos's
              Patient Lieutenant
Trouble: Cannot Resist a Worthy Bargain
Aspects: Form Is Only Makeup
         Only a Spirit's Eye Can Touch Me
         I Have Already Seen Your Trick
...
Stunts
  Form Is Only Makeup: turn Insubstantial as an action;
    cannot be attacked except by Second Sight or a spirit's
    weapon.
  Wear the Field: double a skill die to afflict everyone
    in a zone as one action.
    @@ CORTEX LEAK - Fate has no die doubling. Needs a
    @@ Fate-native recast, and that is a power-level
    @@ decision, not a translation. See work_remaining.
  A Thousand Years of Answers: +2 to defend against any
    approach she has met before.
  Read the Thread: on a successful roll, learn one of a
    character's Aspects and redirect to the gravest threat.
  The Mark Calls Due: spend a Fate point to bring a bound
    debtor or sleeping contract into the scene.
  Brimstone Costume: +2 Provoke vs. those expecting fire.

Stress: Physical [1][2][3][4], Mental [1][2][3][4]
Consequences: Mild, Mild (extra), Moderate, Severe
```
...
```
Distinctions
  Tahanos's Thousand-Year Broker .............. d8
  Cannot Resist a Worthy Bargain .............. d8
  Form Is Only Makeup ......................... d8
Attributes: Mental d12, Social d12, Physical d10
Powers: Illusion d12, Manifestation d12,
        Influence d12, Sorcery d12, Sylph d6

SFX - Everything Is a Seeming: turn Insubstantial and
  raise the shell game (ghost-minions, phantoms, and her).
  Cannot be attacked except by Second Sight or a spirit's
  weapon.
SFX - Wear the Field: double a power die to afflict an
  entire zone; spend a PP to bar flight.
SFX - A Thousand Years of Answers: spend a PP to step up
  a defense die against any approach she has met before.
SFX - The Mark Calls Due: spend a PP to bring a bound
  debtor or sleeping contract into the scene.
SFX - Read the Thread: on a success, learn a Distinction
  and redirect to the gravest threat.
Limit - Smokeless: forced onto a contest of pure air, her
  great powers give way to her lone Sylph d6.
```

### D&D 5e (Ethereal Predator + Hazard + Fallback Block)

```
Note: 5e requires five subsystems. She is assembled, not contained.

Ethereal Dweller. She abides in the Border Ethereal, perceivable and targetable only by truesight, ethereal travelers, or spirit-reaching magic.

Manifestation Effects (lair actions, initiative count 20)

Choking Brimstone. 20-ft. cloud, heavily obscured. DC 16 Con save or 18 (4d8) poison damage and poisoned.

Phantasmal Court. One target: DC 16 Wis save or 13 (3d8) psychic and frightened. Disbelief (DC 16 Investigation) reveals one figure as false - never which others are real, and never which is her.

Whisper of the Bargain. One target: DC 16 Wis save or Wisdom reduced by 1d4 (restored only by greater restoration). At 0 Wisdom: possessed.

Manifest Form (rare; when she deems you worth it)
AC 16, HP 150, Full succubus statistics plus:
Insubstantial. Shed manifest form as a bonus action; return to Ethereal. Takes targetable form only by choice.

Ending her. Her contract-anchor must be undone. (Campaign matter. Unwritten.)
```
...
*Most souls cross the river and forget. This one waded back with the water still in their eyes.*

A reincarnate is not a ghost. They are alive and wholly so - born, breathing, growing, mortal, in need of supper and sleep. But where most souls are washed clean of the far bank on the crossing, this one came back remembering. A child who speaks of a house they have never lived in, a trade they never learned, a wife three villages over who buried a husband by that name. They know how they died the last time, and say so plainly, the way a child reports a dream.

It is rarely a horror. More often it is a quiet wrongness at the edge of a warm life - the grandmother who weeps when the boy calls her by his old mother's name, the girl who walks straight to a drowned man's hidden cache because she hid it, once. The far side sits one thin membrane closer for them than for anyone else alive. Now and then something on the other side notices the door left ajar.

The previous life is a thread, not a leash. It may carry forward knowledge, skills, or debts - a child who can already read, or bargain, or carry a grief that belongs to someone else entirely. Old loves and old enemies may still walk. Unfinished business does not always know it has been inherited. These are the doors the prior life opens, and what comes through them is rarely asked for.

They are a person first and an omen second. The old story is the ground the new one grows from, not the shape it must take.

Liora is a peasant child in a goat-herding village, almost old enough to start thinking about boys. She likes her little wool-tuft dolly, and is fond of frogs she finds by the stream, but seems to know an awful lot about sailing and speaks Celestial like a priestess...
...
```
Level 1 
Hook: A Lifetime Ago, But Not Forgotten
```

An ordinary child otherwise. Tapped, the Hook lends an edge on anything the previous life knew - a skill, a face, a buried secret, a language. As a liability, old debts and old enemies may not know the account has closed.

---

### Fate Core (Supporting NPC or Player Character)
...
### Cortex Prime (Supporting NPC or Player Character)

```
Goatherd's Daughter ......................... d8
  SFX: Debts I Cannot Forget - swap for a d4, earn a PP
Pay a PP, gain a d6 Asset: A Lifetime Ago, But Not Forgotten
```
...
```
Use the Commoner stat block. Add:

Echoes of a Prior Life. The reincarnate retains one skill proficiency, one language, or one tool proficiency from their previous life. They may recognize people, places, or objects connected to that life on a DC 10 Wisdom check (DC rises with time elapsed since the prior life).

Note: 5e has no dual-natured trait mechanic. The liability - inherited debts, old enemies, carried grief - is narration only.
```

---

Publication note: L1 content is original. Fate content is licensed under the Fate Core System SRD (Creative Commons Attribution). Cortex content is "Primed by Cortex" under the Cortex Prime Community License (Rusty Sellsword Design / Dire Wolf Digital, 2026). D&D 5e content uses the 5e SRD under Creative Commons Attribution 4.0. Verify all license terms and attribution requirements before print.

@@ Boundless attribution missing entirely - ORC license, author
@@ consulted directly. Exact wording needed.
@@ Shadowdark and Daggerheart attribution to be added when
