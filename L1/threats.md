[Home](./index.html) › Threats & Obstacles
...
Not generally aggressive unless hungry or threatened. [Hooks](hooks.html) will greatly affect their individual behavior.
...
A Hunting Pack can roll a *Flanking* [Boost](actions-and-timing.html#boost-actions) as a free action.The GM should treat the pack as a single skilled opponent that will use [Boosts](actions-and-timing.html#boost-actions), tap [Hooks](hooks.html), and even use **[Plot Armor](gear.html)!**.
...
[Hook](hooks.html): *Eternity On the Gallows 1*
...
[Hook](hooks.html): *A Woman Scorned 1*
...
If her veil is ever exposed to the moment of sunset, that wail keens out again, and anyone within hearing must resist an EL4 tightening in their chest as their heart breaks. If they have a [Hook](hooks.html) of their own that is in any way relevant, add it as well.
...
Social Camouflage 2  
Sleight of Hand 2  
[Hook](hooks.html): *Can't Resist Pretty Things 2*  
...
When found, the [Hooks](hooks.html) of anyone involved are important. Agnes will use every resource to protect it, and PC [Hooks](hooks.html) are a resource. She will lend her own abilities to any PC roll that keeps and hides it, and oppose any that threaten it in any way. If any [Hook](hooks.html) can be manipulated toward Possession she will take every chance that doesn't expose her. For those able to perceive her, she will eagerly negotiate; she will play the pitiful, ignorant child, but she is canny.

---

- [← Previous: Example Builds](builds.html)
