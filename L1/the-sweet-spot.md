...
The key to good [Maneuvers](maneuvers.html) is **conceptual coherence** - they should represent a meaningful area of expertise with sensible boundaries.
...
[Maneuvers](maneuvers.html) *must* be:

- **Specific enough** to create clear situations where they apply
- **Broad enough** to be useful regularly throughout play
- **Thematically consistent** with their [Role](roles.html) and your character concept

[Maneuvers](maneuvers.html) *should* be:

- **Helpful** - don't waste [Maneuver](maneuvers.html) ranks on rare options!
- **Interesting** - they should support character development
- **Clear** - make sure player and GM have the same idea

[Maneuvers](maneuvers.html) *can* be:

- **Simple** - most [Maneuvers](maneuvers.html) just add their rank to EL when applicable
- **Tactical** - it's fine for a [Maneuver](maneuvers.html) to have a cost for an extra benefit
- **Creative!** - who says Warriors can't have **Flaming Rage** ?
