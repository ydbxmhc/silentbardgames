...
Some things you use aren’t just tools - they have capabilities of their own:
an enchanted sword that guides your hand, a warhorse trained to fight
alongside you, a clockwork automaton that aims a crossbow, or a spirit bound
into a ring. In other settings this might be a ship’s targeting computer, a
powered suit of armor’s HUD, or an onboard AI assist when jacked into the
network.
...
leverage what it offers.

A *Demon Bow* rated at [Sniper](roles/sniper.md) 4 is wasted on a Sniper 1
archer. He gets 1 point of [Boost](actions-and-timing.md#boost-actions) - the
demon tracks, but he can barely keep up with the information it feeds him. A
Sniper 4 archer with the same bow gets the full 4 points - the demon handles
...
The choice between assisted operation and autonomous operation is *usually*
the player’s, and it’s always meaningful. Do you trust your own skill
augmented by the item, or do you trust the thing on its own? That decision can
change from action to action within the same scene.

**You cannot do both for the same action in the same turn.** The item is
either [Boosting](actions-and-timing.md#boost-actions) your roll or making its
own roll. Not both.

It is also not guaranteed - if the GM defines an item as autonomous only, then
it doesn’t have a boost mode. If it is sentient, it may take the choice away
from the PC. Stormbringer didn’t always do quite what Elric wanted.

## Multiple Operators, One System

Some items can support multiple smultaneous users.

When multiple people use the same system simultaneously - a ship’s crew or a
team of mages performing a group ritual spell - each person benefits
independently. The ship’s sleek hydrodynamic design provides a
[Boost](actions-and-timing.md#boost-actions) to the helmsman’s maneuvering,
the long cannon’s extended range helps the gunner’s aim, and the well-stocked
hold helps the engineer’s damage control, all at the same time. Each is capped
by their own relevant [Role](roles.md) rank. While the GM might define each of
these items separately, it’s reasonable to sometimes rank them collectively
...
Don’t overcomplicate items! A powerful, sentient, ancient artifact that can do
several things with its own character sheet is going to complicate your game.
Remember that players can generally generate their own bonuses; cool items
only need to give them an excuse.
...
[Traits](gear-traits.md) plus a [Conceit](nonhuman.md#conceits) An enchanted sword
