...
When the thing you’re working with can *act on its own*, it gets a character sheet — or at least a mini-sheet with a [Level](core-mechanics.html), a [Role](roles.html), and maybe some [Maneuvers](maneuvers.html). The question then becomes: how do you and this thing work together?
...
- **No [Luck Tokens](luck.html).** Items don’t get lucky. Enchanted swords don’t have dramatic last-second saves. Only player characters and major villains do.
- **It’s now an NPC.** If it’s autonomous, you are NOT in control. The GM says what the item does, not you. If it’s a [Beast Handler](roles/beast-handler.html) ’s pet, a [Conjuror](roles/conjuror.html) ’s spirit, or a cursed sword, it will operate within the boundaries of its [Hooks](hooks.html) and the GM’s imagination — and you might, at best, be able to offer advice.
...
ItemTreatment A mundane sworddoesn’t need anything A Masterwork sword[Traits](gear-traits.html) only An enchanted sword that glows near enemies[Traits](gear-traits.html) plus a [Conceit](hooks-in-play.html) An enchanted sword that parries on its ownSheet — that’s the Assist Rule An enchanted sword with its own agendaFull character sheet, [Hooks](hooks.html) and all
