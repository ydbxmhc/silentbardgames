...
Each rank in any [Role](roles.md) comes with a relevant *Maneuver* - a
specific trick that improves the function of the [Role](roles.md) when
applicable. Every [Role](roles.md) has some typical examples a character might
want to use, but players are welcome to invent new ones and negotiate the
details with their group.
