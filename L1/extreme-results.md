...
It always means your turn is **over**. If you had other actions in progress, they are aborted. You *cannot* use a [Luck Token](luck.md), though you *may* still use actual [Karma](karma.md) – but only to make it just a *simple fail*.
