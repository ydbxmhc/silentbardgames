...
Anything beyond trivial effects requires a roll. The Adept channels their **Source** through will, adding their Adept rank, as much of their base Level, and any relevant [Maneuvers](../maneuvers.md) to their EL. Success creates points of effect that can be applied just like any other action.

The key limitation is Overchannelling. An Adept's safe ceiling is their Power Threshold (Role x2: base Level capped at rank, plus rank). If the effect exceeds that, they choose: hold it down to the Threshold - safe, wasting the excess - or let it loose, up to the full power of the roll, and resist the Overage as Harm. That resistance uses their full Level plus rank and any Endurance. It isn't strict either/or - they may commit to any part of the overage, "pulling the punch" as they like, so long as the roll itself succeeded, though the GM is *going* to bring their [Hook](../hooks.md) into play now and then.
