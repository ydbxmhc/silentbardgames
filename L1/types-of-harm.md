...
Still, it is possible that the result someone takes from losing a resistance roll is an Imposed [Hook](hooks.md). See the section on [Hooks](hooks.md) for more info.
