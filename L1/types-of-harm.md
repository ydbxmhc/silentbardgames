...
Still, it is possible that the result someone takes from losing a resistance roll is an Imposed [Hook](hooks.html). See the section on [Hooks](hooks.html) for more info.
