[Home](index.md) › [Hooks](hooks.md) › Hooks on Credit
...
Normally, [Hooks](hooks.md) start at rank 1 - free, no [Karma](karma.md) cost.
They grow through play as they’re triggered and you choose to rank them up.
Sometimes, though, a character concept demands a [Hook](hooks.md) that’s
already deeply embedded in who they are before the story begins.

A knight whose entire identity is built around a sacred oath. A cursed heir
who has lived with the curse for years. A soldier whose conditioning runs so
deep it defines every choice they make. These aren’t rank 1 complications -
...
the [Hook](hooks.md) works in your favor.
...
their first 2 earned [Karma](karma.md) paying off the debt before they can
reduce the [Hook](hooks.md) normally. During that time, the [Hook](hooks.md)
fires at full rank, generating story, creating complications, and - yes -
earning them the [Karma](karma.md) they need to pay it off. The system feeds
itself.
...
Not every [Hook](hooks.md) qualifies for credit. The GM and table should agree
that the [Hook](hooks.md) will create **real, frequent, meaningful
complications**. A [Hook](hooks.md) that’s mostly advantageous -
“Devastatingly Attractive” in a social campaign - doesn’t earn credit unless
the GM commits to making it a genuine problem at least as often as it helps.
...
servitude and the price of power.
