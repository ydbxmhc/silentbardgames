...
![Resistance](Resist-cropped.jpg)

Of course NPCs fight back, but even inanimate objects can present obstacles. A simple, well-oiled lock has low EL; a complex or rusted mechanism is harder. Everything pushes back - when you try something hard, roll your EL against the task's EL.

If you roll a successful 7 and the task rolls a 4, you get effect 3. It's the same fighting a goblin, picking a lock, or sweet-talking a guard, with one very important difference: some things just resist, but others hit back. (You *can* roll over EL and fail outright; we'll explain soon.)

Resistance is passive. It never uses your turn, but also doesn't generate effect. If a locked door isn't trapped it's not likely to hurt you, though it still has a job to do. When Resistance wins a roll all effect is canceled out; this is the same whether something is resisting the actions of your character, or your character is the one resisting. Locks don't open, rocks won't budge, or poison just doesn't work. It might be boring or frustrating, but it's simple.
