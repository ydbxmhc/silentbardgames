...
Something needs to change before another attempt makes sense. Find a better approach, get help from an ally, or discover new information. Create a [Boost](actions-and-timing.html#boost-actions) - a preparatory action that improves your position for the next roll. If you have a *better* EL, you can try again unless the GM thinks you're just metagaming the system (this isn't a video game.)
