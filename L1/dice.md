...
Evens/odds is just a simple way to use any dice you have as zero-based **d2**s…or more accurately, **d[0-1]**s. There’s generally no reason to ever roll fewer than your EL, since every die you add halves the current odds of rolling a zero total. Extra Effort by adding more dice is just manipulating the curve for better odds at a better roll.
