...
An Adept's Power Threshold is Role rank x2: base Level + Adept rank, but as with any feat only a given [Role](../roles.md) can perform, it takes no more base Level than the Adept's rank. A Level 4 Adept 2 has a Threshold of 4 - Adept rank of 2 allows two of their four Levels. [Maneuvers](../maneuvers.md) and [Boosts](../actions-and-timing.md#boost-actions) don't raise this Threshold; they raise the effect you can reach, though… As an option, a table that wants a grimmer game can set the Threshold to the Adept rank *alone*.

An Adept who chooses to *Overchannel* still goes through the normal opposition/resistance to land their effect, but must also immediately resist the overage - any amount their channeled power *exceeds* that Threshold. The resistance roll uses their whole Level, uncapped, plus Adept rank and any Endurance [Maneuver](../maneuvers.md) - shrugging off the burn is the whole body and will, not just the Art. A high-Level, low-rank Adept overreaches easily but weathers it well. Failure means Harm equal to the unresisted overage: exhaustion, disorientation, burst blood vessels, theme-appropriate scorching, or a [Hindrance](../types-of-harm.md) on their self-control. This has nothing to do with how well the effect is resisted by a target once channeled; this is purely a cost of pushing that power through their body and soul. An Adept can always "pull the punch", accepting only as much of a successful roll as they like. A reduced result within their safe limits, discarding any remaining effect, is always safe and requires no resistance roll; there was no Overchanneling. A *little* Overchanneling risk is pretty safe though, right? *"I can handle it…"*

As with most Harm, they often won't know how bad it actually is until they manage a recovery. Conservative Adepts learn to work within their limits, finding creative applications that achieve their goals without exceeding their safe channeling capacity. The reckless (or heroic) burn bright but often burn out, or sometimes are overcome by the power and run amok as an avatar of its essence.
