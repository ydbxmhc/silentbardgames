...
**Magical Healing**: Spells can heal [Injury](types-of-harm.html) point for point of effect after resistance, but you might prefer not to make light of damage taken. If you want to make healing cost, those points transfer to the healer as [Complications](types-of-harm.html). You might also (or alternately) limit magical healing to one extra recovery attempt per game day to prevent it from trivializing physical consequences.
