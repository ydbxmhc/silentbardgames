...
Characters grow through *Karma* - the currency of experience and epic moments.
You'll accumulate Karma during play and spend it to permanently improve your
abilities.

### Earning Karma

Note that the GM *can* earmark any given Karma for Level (or a specific
[Role](roles.md) or [Maneuver](maneuvers.md) if from an Extreme roll) to keep
the party power levels from diverging too much; don't overuse it.

**Attendance**  
Generally, each player should get one point of Karma every session just for
showing up. It's ok to give it at the beginning of the session against the
possibility that they will need it for an emergency, though they can't spend
it on advancement till they get some downtime, usually at the end of the
session.
...
characters to learn from their more dramatic successes and mistakes. Any time
a character rolls an Extreme result, *whether success or failure*, mark the
specific skill. At the end of that session, credit 1 Karma toward the
...
**Just Good Fun**  
The GM should feel free to hand out a Karma just like [Luck Tokens](luck.md)
