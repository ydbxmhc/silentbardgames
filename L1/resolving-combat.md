...
So to actually harm a careful foe - one who both swings and guards - you must
clear *both*: win the contest **and** beat the defense roll. This is why a
skilled, self-preserving fighter is such a brick wall, and why "I hit them
really hard" so often still doesn't land. When someone "punches back," that
costs them a slice of their turn (it's an attack of their own), which is
exactly *why* the smart fighter splits a little into a reusable defense rather
than spending everything on the swing.

## Defense Is a Reusable Soak; Offense Is a Threat

One defense allocation rolls fresh against *every* point of effect that
reaches you this exchange - whether it leaked through a contest or came from
an attacker you never engaged. That makes even a little defense an enormous
bargain against *many* attackers: the swashbuckler's single guard turns aside
the whole room, again and again, as a free action.

Offense, meanwhile, does double duty. The points you aim at a foe force *them*
to hold defense back or eat your effect - taxing their budget. Your attack
protects you indirectly, by making the enemy split their attention too. A
creature with strong offense and no defensive skill is still well-guarded
whenever it can *oppose*: its attack's margin keeps it safe. It is only
fragile against attacks it cannot answer.
...
At its simplest, combat is the whole system in miniature: assign a difficulty,
roll, compare, narrate. The deep game is the *same numbers* with these two
axes in mind - multi-target offense, a reusable defense, wagers, and shaped
dice pools. A table that wants quick, cinematic fights and a table that wants
tense, realistic tactics are playing the identical engine at different
resolutions. That duality is the whole point.
