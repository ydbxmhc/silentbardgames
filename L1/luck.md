[Home](index.html) › Core Mechanics › Luck Tokens
...
- Use one as **[Plot Armor](gear.html)!** to have your armor take ALL the damage from a hit (see [Gear](gear.html) .)
- Use one to absorb and negate a point of Harm you are about to take – sometimes Luck can be better than armor.
- Use one to power a [Maneuver](maneuvers.html) ; most [Maneuvers](maneuvers.html) don’t need them, but some are so strong they require limits.
- Use one to power a particularly potent spell! They also make great bargaining chips for deals with spirits… “Grant me the breath of thy life for a minute’s span…”  
  (More powerful spirits will want actual [Karma](karma.html) ; weak ones will be happy with booze, or incense, etc.)
...
- [← Previous: Wagered Actions](wagered-actions.html)
- [Next →: Picking Your Dice](dice.html)
